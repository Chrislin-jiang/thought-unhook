      ...
      <AnimatePresence mode="wait">
        ...
        {phase === 'intro' && (
          ...
          >
            ...
            <h2 className="text-lg font-medium mb-3" style={{ color: '#2D2B55' }}>认识脑内角色</h2>
            <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}
              className="text-sm text-center mb-2 leading-relaxed" style={{ color: 'rgba(45,43,85,0.5)' }}>
              让我们来认识一下住在你脑子里的小伙伴们
            </motion.p>
            <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1 }}
              className="text-xs text-center mb-8" style={{ color: 'rgba(45,43,85,0.25)' }}>
        ...
        {phase === 'input' && (
          ...
          >
            <p className="text-center text-sm mb-4" style={{ color: 'rgba(45,43,85,0.45)' }}>
              写下 3-5 个最近反复出现的念头
            </p>
              ...
              <div className="space-y-2 mb-4">
                {thoughts.map((t, i) => (
                  <motion.div key={i} initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }}
                    ...
                    style={{ background: 'rgba(139,124,247,0.08)', border: '1px solid rgba(139,124,247,0.15)', color: 'rgba(45,43,85,0.65)' }}>
            ...
            {thoughts.length < 5 && (
              <div className="relative mb-4">
                <textarea ref={inputRef} value={input} onChange={e => setInput(e.target.value)}
                  ...
                  style={{ background: 'rgba(139,124,247,0.04)', border: '1px solid rgba(139,124,247,0.1)',
                    borderRadius: '14px', color: '#2D2B55', padding: '12px 16px',
        ...
        {phase === 'analyzing' && (
          ...
          >
            ...
            <p className="text-sm" style={{ color: 'rgba(45,43,85,0.5)' }}>AI 正在分析你的念头...</p>
            <p className="text-xs mt-2" style={{ color: 'rgba(45,43,85,0.25)' }}>识别脑内角色中</p>
          </motion.div>
        )}
            ...
            <AnimatePresence mode="wait">
              {revealedIndex >= 0 && revealedIndex < personas.length && (
                ...
                >
                  ...
                  <h3 className="text-xl font-medium mb-2" style={{ color: '#2D2B55' }}>
                    {personas[revealedIndex].name}
                  </h3>
                  <p className="text-xs leading-relaxed mb-3" style={{ color: 'rgba(45,43,85,0.5)' }}>
            ...
            <div className="flex gap-2 mt-8">
              {personas.map((_, i) => (
                <div key={i} className="w-2 h-2 rounded-full" style={{
                  background: i <= revealedIndex ? 'rgba(139,120,255,0.8)' : 'rgba(139,124,247,0.1)',
                }} />
              ))}
            </div>
          </motion.div>
        ...
        {phase === 'nickname' && (
          ...
          >
            <p className="text-center text-sm mb-2" style={{ color: 'rgba(45,43,85,0.65)' }}>
              你的脑内角色阵容 👥
            </p>
            <p className="text-center text-xs mb-6" style={{ color: 'rgba(45,43,85,0.25)' }}>
              你可以给每个角色起一个昵称
            </p>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="text-sm font-medium" style={{ color: '#2D2B55' }}>
                        ...
                        <p className="text-xs mb-2" style={{ color: 'rgba(45,43,85,0.45)' }}>
                        ...
                        {isEditing ? (
                          <div className="flex items-center gap-2 mt-2">
                            ...
                            <button
                              ...
                              style={{ background: 'rgba(139,124,247,0.2)', color: 'rgba(45,43,85,0.8)', border: 'none', cursor: 'pointer' }}
                            >
                              ✓
                            </button>
                          </div>
                          ...
                          <button
                            ...
                            style={{ background: 'rgba(139,124,247,0.04)', color: 'rgba(45,43,85,0.35)', border: '1px solid rgba(139,124,247,0.06)', cursor: 'pointer' }}
                          >
            ...
            <div className="text-center">
              ...
              <p className="text-xs mt-3" style={{ color: 'rgba(45,43,85,0.25)' }}>
                下次它们说话时，你可以说——"又是你啊！"
              </p>
            </div>
        ...
        {phase === 'done' && (
          ...
          >
            ...
            <p className="text-lg text-center mb-2" style={{ color: 'rgba(45,43,85,0.8)' }}>你认识了你的脑内角色</p>
            <p className="text-xs text-center mb-6 leading-relaxed" style={{ color: 'rgba(45,43,85,0.35)' }}>
              现在你知道了——那些声音不是"你"，<br />
              是不同的角色在说话。<br />
              下次它们出现时，跟它们打个招呼吧 👋
            </p>
